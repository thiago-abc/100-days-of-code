...
if left_or_right == "left":
    wait_of_swim = input("You come to a lake. The is as island in the middle of the lake. Type \"wait\" to wait for a boat. Type \"swim\" to swim across.\n").lower()
    if wait_of_swim == "wait":
